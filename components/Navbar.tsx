  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
        <a href="#inicio" className="relative w-10 h-10 flex-shrink-0" aria-label="El Huerto del Tunche — Inicio">
          <Image
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Navegación principal">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="relative font-body text-xs tracking-widest uppercase text-tunche-neblina hover:text-tunche-humo transition-colors duration-300 group"
            >
              {link.label}
        ...
        >
          <span
            className={`block h-px w-6 bg-tunche-humo transition-all duration-300 ${
